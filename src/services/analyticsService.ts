...
export const trackEngagement = async (
  userId: string,
  eventType: 'core_action_used' | 'item_added' | 'item_updated' | 'feature_used' | 'shopping_list_item_added' | 'shopping_list_item_crossed_off' | 'calendar_viewed' | 'barcode_scanned',
